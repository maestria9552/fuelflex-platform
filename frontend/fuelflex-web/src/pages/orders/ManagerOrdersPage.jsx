...
const statusKeys = {
  ...
  PENDING_SUPPLIER_APPROVAL: "pendingSupplier", SUPPLIER_REJECTED: "supplierRejected", AWAITING_RECEPTION: "awaitingReception", PARTIALLY_RECEIVED: "partiallyReceived", RECEIVED: "received",
};

function statusLabel(status, t) { const key = statusKeys[status]; return key ? t(`orders:statuses.${key}`) : status || "—"; }
