import { BarChart3, ClipboardCheck, FileText, LayoutDashboard, PackageCheck, ShoppingCart, X } from "lucide-react";
...
const groups = [
  ...
  { id: "operations", label: "groups.operations", items: [{ id: "orders", label: "items.orders", path: "/gerant/commandes", icon: ClipboardCheck }, { id: "receipts", label: "items.receipts", path: "/gerant/receptions", icon: PackageCheck }, { id: "sales", label: "items.sales", icon: ShoppingCart, soon: true }, { id: "closing", label: "items.closing", icon: FileText, soon: true }] },
