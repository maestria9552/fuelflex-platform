...
public final class PosSaleDtos {private PosSaleDtos(){}
 ...
 public record SaleReadFilter(UUID stationId,UUID operationalDayId,UUID pumpAttendantId,SaleType saleType,SaleStatus status,OffsetDateTime soldFrom,OffsetDateTime soldTo){}
