...
public final class OperationalDtos { private OperationalDtos(){}
 ...
 public record PosOperationalContext(UUID operationalDayId,UUID assignmentId,UUID organizationId,UUID stationId,String stationName,UUID pumpId,String pumpName,UUID dispensingPointId,UUID fuelMeterId,String fuelMeterName,BigDecimal openingIndex){}
}
